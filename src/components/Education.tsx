...
export const Education = () => {
  ...
  const sortedCertifications = certifications.length > 0 ? [...certifications].sort((a, b) => {
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-primary bg-clip-text text-transparent animate-fade-in-down">
            {certifications.length > 0 ? 'Education & Certifications' : 'Education'}
          </h2>
        ...
        <div className={`grid grid-cols-1 ${certifications.length > 0 ? 'lg:grid-cols-2' : ''} gap-12`}>
          {/* Education Section */}
          <div>
