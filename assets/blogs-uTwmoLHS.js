...
`;typeof global>"u"&&(window.global=window);window.Buffer=m.Buffer;const w=Object.assign({"../blogs/angular-component-communication.md":p,"../blogs/angular-custom-form-controls.md":u,"../blogs/angular-deferrable-views.md":h,"../blogs/angular-signal-forms.md":g,"../blogs/angular-signals.md":f,"../blogs/dotnet-server-sent-events.md":b,"../blogs/getting-started-with-react.md":v,"../blogs/web-performance-optimization.md":y,"../blogs/yarp-reverse-proxy.md":S});let a=null;async function C(){if(a)return a;const n=[];for(const[e,t]of Object.entries(w))try{const i=(e.split("/").pop()||"").replace(".md","").toLowerCase(),s=String(t),{data:l,content:c}=d(s),r=l;n.push({slug:i,title:r.title,date:r.date,summary:r.summary,tags:r.tags||[],body:c})}catch(o){console.error(`[Blogs] Error loading blog ${e}:`,o)}return n.sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),a=n,n}async function A(n){return(await C()).find(o=>o.slug===n)}export{A as g,C as l};
