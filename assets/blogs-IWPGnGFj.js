...
`;typeof global>"u"&&(window.global=window);window.Buffer=m.Buffer;const b=Object.assign({"../blogs/angular-component-communication.md":p,"../blogs/angular-signals.md":u,"../blogs/getting-started-with-react.md":g,"../blogs/web-performance-optimization.md":h,"../blogs/yarp-reverse-proxy.md":f});let r=null;async function v(){if(r)return r;const n=[];for(const[e,t]of Object.entries(b))try{const a=(e.split("/").pop()||"").replace(".md","").toLowerCase(),i=String(t),{data:l,content:c}=d(i),s=l;n.push({slug:a,title:s.title,date:s.date,summary:s.summary,tags:s.tags||[],body:c})}catch(o){console.error(`[Blogs] Error loading blog ${e}:`,o)}return n.sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),r=n,n}async function S(n){return(await v()).find(o=>o.slug===n)}export{S as g,v as l};
