import{m as d}from"./vendor-gray-matter-vf1yZiCi.js";import{b as m}from"./vendor-buffer-DXMK02ny.js";const p=`---
...
`;typeof global>"u"&&(window.global=window);window.Buffer=m.Buffer;const S=Object.assign({"../blogs/angular-component-communication.md":p,"../blogs/angular-deferrable-views.md":u,"../blogs/angular-signal-forms.md":g,"../blogs/angular-signals.md":h,"../blogs/dotnet-server-sent-events.md":f,"../blogs/getting-started-with-react.md":v,"../blogs/web-performance-optimization.md":b,"../blogs/yarp-reverse-proxy.md":y});let a=null;async function w(){if(a)return a;const n=[];for(const[e,t]of Object.entries(S))try{const i=(e.split("/").pop()||"").replace(".md","").toLowerCase(),s=String(t),{data:l,content:c}=d(s),r=l;n.push({slug:i,title:r.title,date:r.date,summary:r.summary,tags:r.tags||[],body:c})}catch(o){console.error(`[Blogs] Error loading blog ${e}:`,o)}return n.sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),a=n,n}async function x(n){return(await w()).find(o=>o.slug===n)}export{x as g,w as l};
